...
var require_ngraph = __commonJS({
  "node_modules/ngraph.events/index.js"(exports2, module) {
...
var require_ngraph2 = __commonJS({
  "node_modules/ngraph.graph/index.js"(exports2, module) {
...
var require_getVariableName = __commonJS({
  "node_modules/ngraph.forcelayout/lib/codeGenerators/getVariableName.js"(exports2, module) {
...
var require_createPatternBuilder = __commonJS({
  "node_modules/ngraph.forcelayout/lib/codeGenerators/createPatternBuilder.js"(exports2, module) {
...
var require_generateCreateBody = __commonJS({
  "node_modules/ngraph.forcelayout/lib/codeGenerators/generateCreateBody.js"(exports2, module) {
...
var require_generateQuadTree = __commonJS({
  "node_modules/ngraph.forcelayout/lib/codeGenerators/generateQuadTree.js"(exports2, module) {
    var createPatternBuilder = require_createPatternBuilder();
    var getVariableName = require_getVariableName();
...
var require_generateBounds = __commonJS({
  "node_modules/ngraph.forcelayout/lib/codeGenerators/generateBounds.js"(exports2, module) {
...
var require_generateCreateDragForce = __commonJS({
  "node_modules/ngraph.forcelayout/lib/codeGenerators/generateCreateDragForce.js"(exports2, module) {
    var createPatternBuilder = require_createPatternBuilder();
...
var require_generateCreateSpringForce = __commonJS({
  "node_modules/ngraph.forcelayout/lib/codeGenerators/generateCreateSpringForce.js"(exports2, module) {
    var createPatternBuilder = require_createPatternBuilder();
...
var require_generateIntegrator = __commonJS({
  "node_modules/ngraph.forcelayout/lib/codeGenerators/generateIntegrator.js"(exports2, module) {
    var createPatternBuilder = require_createPatternBuilder();
...
var require_spring = __commonJS({
  "node_modules/ngraph.forcelayout/lib/spring.js"(exports2, module) {
...
var require_ngraph3 = __commonJS({
  "node_modules/ngraph.merge/index.js"(exports2, module) {
...
var require_ngraph4 = __commonJS({
  "node_modules/ngraph.random/index.js"(exports2, module) {
...
var require_createPhysicsSimulator = __commonJS({
  "node_modules/ngraph.forcelayout/lib/createPhysicsSimulator.js"(exports2, module) {
...
var require_ngraph5 = __commonJS({
  "node_modules/ngraph.forcelayout/index.js"(exports2, module) {
  ...
  "node_modules/tinycolor2/tinycolor.js"(exports2, module) {
    (function(Math2) {
      ...
      function tinycolor(color2, opts) {
        ...
        this._originalInput = color2, this._r = rgb3.r, this._g = rgb3.g, this._b = rgb3.b, this._a = rgb3.a, this._roundA = mathRound(100 * this._a) / 100, this._format = opts.format || rgb3.format;
      ...
      tinycolor.prototype = {
        ...
        toHsl: function() {
          var hsl4 = rgbToHsl2(this._r, this._g, this._b);
          return { h: hsl4.h * 360, s: hsl4.s, l: hsl4.l, a: this._a };
        },
        toHslString: function() {
          var hsl4 = rgbToHsl2(this._r, this._g, this._b);
          var h = mathRound(hsl4.h * 360), s = mathRound(hsl4.s * 100), l = mathRound(hsl4.l * 100);
      ...
      function triad(color2) {
        ...
        return [
          tinycolor(color2),
          tinycolor({ h: (h + 120) % 360, s: hsl4.s, l: hsl4.l }),
          tinycolor({ h: (h + 240) % 360, s: hsl4.s, l: hsl4.l })
        ];
      }
      function tetrad(color2) {
        ...
        return [
          tinycolor(color2),
          tinycolor({ h: (h + 90) % 360, s: hsl4.s, l: hsl4.l }),
          tinycolor({ h: (h + 180) % 360, s: hsl4.s, l: hsl4.l }),
          tinycolor({ h: (h + 270) % 360, s: hsl4.s, l: hsl4.l })
        ];
      }
      function splitcomplement(color2) {
        ...
        return [
          tinycolor(color2),
          tinycolor({ h: (h + 72) % 360, s: hsl4.s, l: hsl4.l }),
          tinycolor({ h: (h + 216) % 360, s: hsl4.s, l: hsl4.l })
        ];
      }
...
var DragControls = class extends EventDispatcher {
  constructor(_objects, _camera3, _domElement) {
    super();
    ...
    function onPointerMove(event) {
      if (scope.enabled === false)
        return;
      updatePointer(event);
      _raycaster.setFromCamera(_pointer, _camera3);
      if (_selected) {
      ...
      if (event.pointerType === "mouse" || event.pointerType === "pen") {
        ...
        if (_intersections.length > 0) {
          ...
          _plane.setFromNormalAndCoplanarPoint(_camera3.getWorldDirection(_plane.normal), _worldPosition.setFromMatrixPosition(object.matrixWorld));
    ...
    function onPointerDown(event) {
      ...
      if (_intersections.length > 0) {
        ...
        _plane.setFromNormalAndCoplanarPoint(_camera3.getWorldDirection(_plane.normal), _worldPosition.setFromMatrixPosition(_selected.matrixWorld));
        if (_raycaster.ray.intersectPlane(_plane, _intersection)) {
...
var index_array_by_module_default = index5;
...
function formatLocale(locale3) {
  ...
  function newFormat(specifier, formats2) {
    return function(date) {
      var string = [], i = -1, j = 0, n = specifier.length, c4, pad2, format3;
...
function threeDigest(data, scene3) {
  ...
  var _ref$objFilter = _ref.objFilter, objFilter = _ref$objFilter === void 0 ? function() {
    return true;
  } : _ref$objFilter, options = _objectWithoutProperties3(_ref, _excluded);
        ...
        state.graphData.links.forEach(function(link) {
          ...
          if (line.type === "Line") {
            ...
            if (!curve) {
              ...
              var _r = _linkWidth / 2;
              var _geometry3 = new three$1.TubeBufferGeometry(curve, curveResolution, _r, state.linkResolution, false);
              line.geometry.dispose();
...
function hslToRgb(hue2, saturation, lightness, convert) {
  if (convert === void 0) {
...
function parseToRgb(color2) {
  ...
  if (hslMatched) {
    ...
    var rgbColorString = "rgb(" + hslToRgb(hue2, saturation, lightness) + ")";
...
function hslToHex(hue2, saturation, lightness) {
  return hslToRgb(hue2, saturation, lightness, convertToHex);
}
