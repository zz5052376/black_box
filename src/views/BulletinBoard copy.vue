      ...
      <el-col :span="24">
        <el-card shadow="hover">
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="address" label="用例详情" width="300px"> </el-table-column>
          </el-table>
        </el-card>
      </el-col>
    </el-row>
...
export default {
  ...
  mounted() {
    ...
    this.option.series[0].data = this.dataversion[0];
    this.option.series[1].data = this.datareversal(this.dataversion[1]);
  ...
  methods: {
    ...
    next(num, num2) {
      this.active = num;
      this.option.series[0].data = this.dataversion[num2];
      this.option.series[1].data = this.datareversal(this.dataversion[num]);
      this.myChart.setOption(this.option);
    },
  },
  setup() {
